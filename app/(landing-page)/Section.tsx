...
const items = [
    {
        ...
        button: (
            <div
                className="text-sky-500 flex items-center hover:cursor-pointer pt-6"
            ></div>
        ),
        image: "/images/youdentifi-wiki.svg",
    },
    {
        ...
        button: (
            <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
                Create and manage your unique decentralized identifier (DID) on
                the blockchain.
            </div>
        ),
    },
    ...
    },
    {
        ...
        button: (
            <div className="text-sky-500 flex items-center  hover:cursor-pointer pt-6">
                Share your verified digital identity securely with others and on
...
const Section = () => {
    return (
        <>
            ...
            <div
                className="grid xl:grid-cols-4 pb-32 md:grid-cols-2  md:row-span-1 gap-4 xl:gap-6 mt-8 px-8  md:px-16 xl:px-0 xl:w-3/4  2xl:w-[55%] mx-auto md:w-full"
            >
