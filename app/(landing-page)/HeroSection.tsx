...
const HeroSection = () => {
    ...
    return (
        <div className="md:items-center flex flex-col cont">
            <div className="font-medium 2xl:w-2/3 md:w-2/3 xl:w-1/2 lg:px-0 px-8 text-5xl xl:text-6xl flex justify-center xl:font-medium xl:pt-14 text-center pt-6">
            ...
            {isSmallScreen ? (
                <div className="grid-cols-1 grid md:grid-cols-2 place-content-center place-items-center mx-auto space-x-0  xl:space-x-4 items-center justify-between hover:cursor-pointer gap-4 ">
                    {tabs.map((tab) => (
                        <motion.div
                            key={tab.name}
                            className={` xl:flex justify-center space-x-4 xl:pt-4 sm:my-10 xl:my-0 w-full md:w-60 h-36 ${
                                activeTab === tab
                ...
                <div className="flex xl:space-x-4 items-center justify-between hover:cursor-pointer gap-4 w-full md:w-4/5">
                    {tabs.map((tab) => (
                        <motion.div
                            key={tab.name}
                            className={` xl:flex  justify-center  space-x-4 xl:pt-4 sm:my-10 xl:my-0 w-full md:w-60 h-36 ${
