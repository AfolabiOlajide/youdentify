...
const Section = () => {
    ...
    const { getUserByAddress, getUsernameByAddress, getUserByUsername } = useQueries()
                        ...
                        <div className="flex flex-col items-center justify-center pt-4 mx-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 w-full ">
                                {formData?.skills?.map((skill: any) => (
                                    <div key={skill} className="flex flex-row items-center bg-white w-max  space-x-2  px-3 py-2 rounded-lg">
