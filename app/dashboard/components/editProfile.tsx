...
import UserProfileDisplay from "@/app/onboard/components/UserProfileDisplay";
import FormFields from "@/app/onboard/components/FormFields";
import CustomImageUploader from "@/components/ui/CustomImageUploader";
import SocialMediaInputs from "@/app/onboard/components/SocialMediaInputs";
...
export default function EditProfile() {
    ...
    const { getUserByAddress, getUsernameByAddress, editUser, isQueryError, isQuerySuccess } = useQueries();
    ...
    useEffect(() => {
        const getUserInfo = async () => {
            try {
                ...
                // setSelectedOptions(userInfo.professionalInfo.skills as string[]);
                // console.log(userInfo.professionalInfo.skills)
    ...
    const handleImagesChange = async (files: File[]) => {
        ...
        try {
            ...
            const options = {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${process.env.NEXT_PUBLIC_PINATA_JWT_SECRET}`,
                },
                body: form,
            };
